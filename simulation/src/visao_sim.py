...
class ImageConverter:
    def __init__(self):
        ...
        cv2.setTrackbarPos('R', 'RGB Trackbars', 146)
        cv2.setTrackbarPos('G', 'RGB Trackbars', 71)
        cv2.setTrackbarPos('B', 'RGB Trackbars', 0)
        cv2.setTrackbarPos('Tolerancia', 'RGB Trackbars', 20)
